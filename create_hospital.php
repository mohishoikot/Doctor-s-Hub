...
<form method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="validationDefault01" placeholder="Location" name="location"  required>
  </div>
  <div class="form-group">
   <label for="form-control form-control-lg">Image</label>
    <input type="text" class="form-control" id="validationDefault01" placeholder="Image" name="imgLink"  required>
  </div>
  <div class="form-group">
